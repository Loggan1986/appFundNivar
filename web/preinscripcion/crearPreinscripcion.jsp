...
<body>	
      ...
      <div class="row">
        <div class="col-md-12 pull-left">
          <a href="#regpreins" class="btn btn-info btn-lg" data-toggle="modal">Registrar</a>
          
          <div class="modal fade" id="regpreins">
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-header">
                    ...
                    <h2 class="modal-title" align="center">Registro</h2>
                  </div>
          
                  <!-- Contenido del modal -->
          
                  <div class="modal-body">
                    <p align="justify">Los datos ingresados seran almacenados en el sistema, desea continuar la operación.
                    Verifique que los datos se encuentren correctamente diligenciados</p>
                  </div>
                  ...
                  <div class="modal-footer">
                    ...
                    <a href="#guardarpre" class="btn btn-info btn-lg" data-toggle="modal" collapsed>Guardar</a>
                  </div>
            ...
            <div class="modal fade" id="guardarpre">
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                    <h2 class="modal-title" align="center">Mensaje</h2>
                  </div>
          
                  <!-- Contenido del modal -->
          
                  <div class="modal-body">
                    <p align="justify">Los datos han sido almacenados con exito</p>
                  </div>
          
                  <!-- Footer del modal -->
          
                  <div class="modal-footer">
                    <a type="button" class="btn btn-info btn-lg" href="preinscripcion.html">Aceptar</a>
                  </div>
